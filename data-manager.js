(function(){
  ...
  function migrate(input){
    ...
    data.regions=data.regions||Object.keys(data.sceneMaps);data.deletedRecordIds=[...new Set(data.deletedRecordIds||[])];data.sync={lastSyncedAt:null,revision:0,...data.sync};
    return data;
  }
